...
export default class InformeCuotas extends Component {
    render() {
        return (
            <View style={styles.fondo}>
                ...
                <Text style={{ fontSize: 25, fontWeight: 'bold', textAlign: 'center', bottom: 45, fontFamily: "sans-serif" }}>INFORME CUOTAS</Text>
                <Divider style={{ backgroundColor: 'black', height: 2, justifyContent: 'space-around', bottom: 35 }} />
                <View style={{marginTop:80}}>
                    <View>
                        <Text style={{ fontSize: 20, marginLeft: 10 }}>Cuota Inicio</Text>
                        <Input style={styles.estiloInput}
                            placeholder='Cuota Inicio'
                            containerStyle={{ width: 150 }}
                        />
                    </View>
                    <View style={{ alignSelf: 'flex-end', bottom: 104 }}>
                        <Text style={{ fontSize: 20, marginRight: 10 }}>Cuota Fin</Text>
                        <Input style={styles.estiloInput2}
                            placeholder='Cuota Fin'
                            containerStyle={{ width: 150 }}
                        />
                    </View>
                    {btnGuardar('Filtrar')}
